...
SECRET_KEY = "a667856a575286b062c0cf99547d4964b45cdd05b87a7c21e0a3939eb526acdc"
ALGORITHM = "HS256"
...
#     "nazar": {
#         "username": "nazar",
#         "fullname": "Nazar Hasanov",
#         "email": "nazar@gmail.com",
#         "hashed_password": "$2b$12$QiSHn38gLG.A4AkRJ1gMDu7Zg0/DnAZaDMQS99N8Bt4tTNvceC2Oa",
#         "disabled": False
#     }
# }
...
# ! Since it relies(depends) on get_current_active_user only authorised users can access
async def read_users_me(current_user: User = Depends(get_current_active_user)):
    return current_user


@app.get("/users/me/itema")
async def read_users_me(current_user: User = Depends(get_current_active_user)):
    return [{"item_id":1, "owner":current_user}]


# pwd = get_password_hash("nazar00")
# print(pwd)
